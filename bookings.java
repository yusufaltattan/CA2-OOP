...
public class bookings {
    ...
    public static void main(String[] args) {
        ...
        if (option.equals("1")) {
            ...
            System.out.print(entry + "Adding bookable room"+ "\n" + "\n" + "<List rooms here> "+ "\n" + "Please, enter one of the following" + "\n" + "\n" + "The sequential ID listed to a room, a date (dd/mm/yyyy), and a time (HH:MM), separated by a white space." + ending);
        }
        ...
        //    System.out.print("Error!" + "\n" + "<Message explaining error>"+ "\n" + "Please, enter one of the following" + "\n" + "\n" + "The sequential ID to select the bookable room to be removed." + ending);
            ...
            System.out.print(entry + "<list assistans on shift>"+ending);
        }
        else if (option.equals("5")) {
            System.out.print(entry + "Adding assistant on shift"+ "\n" + "\n" + "<List assistants here> "+ "\n" + "Please, enter one of the following" + "\n" + "\n" + "The sequential ID of an assistant and date (dd/mm/yyyy), separated by a white space." + ending);
        }
        // If the booking is valid
        ...
        //    System.out.print("Error!" + "\n" + "<Message explaining error>"+ "\n" + "Please, enter one of the following" + "\n" + "\n" + "The sequential ID to select the assistant on shift to be removed." + ending);
            ...
            System.out.print(entry + "Adding booking (appointment for a COVID test) to the system" + "\n" + "\n" + "List of available time-slots:"+ "\n" + "11. dd/mm/yyyy HH:"+ "\n" + "12. dd/mm/yyyy HH:"+ "\n" + "13. dd/mm/yyyy HH:"+"\n" + "..."+ "\n"+"Please enter one of the following:"+ "\n"+ "\n" + "The sequential ID of an available time-slot and the student email, seperated by a white space."+ ending);
            // If valid
            ...
            System.out.print(entry + "<List booking status: SCHEDULED>" + "\n" + "Removing booking from the system"+ "\n" + "\n" +"Please enter one of the following:"+ "\n"+ "\n" + "The sequential ID to select the booking to be removed from the listed bookings above."+ ending);
            // If valid
            ...
            System.out.print(entry + "<List booking status: SCHEDULED>" + "\n" + "Conclude booking"+ "\n" + "\n" +"Please enter one of the following:"+ "\n"+ "\n" + "The sequential ID to select the booking to be completed."+ ending);
            // If valid
